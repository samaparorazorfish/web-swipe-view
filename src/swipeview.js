    ...
    SwipeView.prototype = {
        ...
        handleEvent: function (e) {
            switch (e.type) {
                ...
                case 'otransitionend':
                    window.clearInterval(flipTimerID);
        ...
        _pos: function (x) {
            ...
            flipTimerID = window.setTimeout(function(){
                var ev = document.createEvent('Event');
                ev.initEvent(transitionEndEvent, true, true);
                _this.slider.dispatchEvent(ev);
            }, this.pageTurnSpeed + 25)
        },
